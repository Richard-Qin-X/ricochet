file (GLOB_RECURSE RICOCHET_CC_FILES ${CMAKE_SOURCE_DIR}/src/*.cc)
...
foreach (tidy_target ${ALL_SRC_FILES})
  ...
  if (${tidy_target} IN_LIST RICOCHET_CC_FILES)
    list (APPEND RICOCHET_TIDY_TARGETS tidy_${tidy_target_name})
  endif ()
endforeach (tidy_target)

add_custom_target (tidy DEPENDS ${RICOCHET_TIDY_TARGETS})
